...
const AppointmentForm = () => {
  ...
  const submithandler = async(event) => {
    ...
    try {
      const res = await  axios.post("http://localhost:8080/patient/appointment", appointmentData, {
        headers: {
  ...
  return (
   ...
   <Grid container xs={12} sx={{ mt:"50px",display:"flex",justifyContent:"center",alignItems:"center", padding: '10px',
        borderRadius: '5px', boxShadow: '0px 2px 4px rgba(0, 0, 0, 0.2)'}}>
      ...
      Appointment Now
        ...
        <Grid item xs={12}>
          <Button textAlign="center" type="submit" variant="contained" color="primary" onClick={submithandler}>
            Submit
          </Button>
        </Grid>
      </Grid>
