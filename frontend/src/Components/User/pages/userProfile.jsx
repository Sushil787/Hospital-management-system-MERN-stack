...
//     try {
//         const response = await axios.put('http://localhost:8080/updatepatient', {
//             username: userName,
//             email: userEmail,
...
//     // setIsEditing(false);
//     // You can add logic here to save the updated user information.
//   };

//   const handleCancelClick = () => {
//     setIsEditing(false);
//     // You can add logic here to reset the user information to the original values.
...
const UserProfile = () => {
  ...
  return (
    ...
    <>
      <Typography maxWidth="lg"  variant="h4" sx={{
        textAlign: 'center',
        marginTop: '20px',
        marginBottom: '20px',
